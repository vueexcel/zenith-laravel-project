...
class RiddorIncidentController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['report_name'] = 'riddor_incidents';
        $data['current_year'] = $current_year;
        $data['title'] = 'RIDDOR Incidents';
        $data['sub_title'] = '';
        $data['action'] = route('report::riddor_incidents.export_report');
    ...
    public function export_report(Request $request)
    {
        ...
        $export_sheets = ['RIDDOR List From Database', 'RIDDOR Incidents'];
