...
class LostTimeAccidentController extends Controller
{
    //
    public function index()
    {
        ...
        $data['sub_title'] = '';
        return view('report.lost_time_accidents.index', $data);
    }

    public function get_report(Request $request)
    {
        $report_data = $this->get_report_data_with_post($request);
        return view('report.lost_time_accidents.list', $report_data);
    }

    public function export_report(Request $request)
    {
        $report_data = $this->get_report_data_with_post($request);
        $file_name = "lost_time_accidents.xlsx";
