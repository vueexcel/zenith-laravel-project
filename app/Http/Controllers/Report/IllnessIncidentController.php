...
class IllnessIncidentController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['report_name'] = 'Illness_incidents';
        $data['current_year'] = $current_year;
        $data['title'] = 'Illness Incidents';
        $data['sub_title'] = '';
        $data['action'] = route('report::illness_incidents.export_report');
