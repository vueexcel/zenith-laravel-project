...
class ContractorAccidentController extends Controller
{
    use ReportController;

    public function __construct()
    {
        $this->check_group_code('contractor_accidents');
    }
    ...
    public function index()
    {
        ...
        $data['report_name'] = 'contractor_accidents';
        $data['current_year'] = $current_year;
        $data['title'] = 'Contractor Accidents';
        $data['sub_title'] = '';
        $data['action'] = route('report::contractor_accidents.export_report');
