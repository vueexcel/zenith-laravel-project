...
class RestrictionController extends Controller
{
    ...
    public function index($report_type)
    {
        ...
        $data['report_name'] = 'restriction_cost';
        $data['current_year'] = $current_year;
        $data['title'] = 'Restriction Cost';
        switch ($report_type) {
            case 'days' : $data['sub_title'] = 'Days'; break;
            case 'cost' : $data['sub_title'] = 'Cost'; break;
            default : $data['sub_title'] = ''; break;
        }
        $data['action'] = route('report::restriction_cost.export_report');
