...
class WorkOtherIncidentController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['report_name'] = 'work_other_incidents';
        $data['current_year'] = $current_year;
        $data['title'] = 'Work Other Incidents';
        $data['sub_title'] = '';
        $data['action'] = route('report::work_other_incidents.export_report');
            ...
            foreach($groups as $index => $group){
                ...
                $query = DB::table('health_concerns')
                    ...
                    ->where(function($query){
                        ...
                        $query->orWhere('origin',  'Work Aggravated')->where('origin_type_id', $origin_type->id);
                        $query->orwhere('origin',  'Work')->where('origin_type_id', $origin_type2->id);
