...
{{-- Page Title --}}
@section('page-title', 'Quick Near Miss')
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-xs-12">
            <h3 style="color: #00a7d0;">Causation Factors &nbsp;&nbsp;<a class="btn btn-success btn-sm item-create" data-item="causation_factors">Add New</a></h3>
            <div class="col-md-12" id="div_causation_factors" style="background-color: #fff; padding: 10px; min-height: 560px; height: auto"></div>
        </div>
