            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="active tab-pane" id="settings">
                        <form class="form-horizontal" enctype="multipart/form-data" role="form" method="POST" action="{{ route('dashboard::profile.update') }}">
                            {!! csrf_field() !!}
                            ...
                            <div class="form-group{{ $errors->has('logo_file') ? ' has-error' : '' }}">
                                <label for="logo_file" class="col-sm-2 control-label">Logo Upload</label>
