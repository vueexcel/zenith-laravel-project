...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <title>{{ config('app.name', 'HealthSafety') }} @hasSection('page-title') | @yield('page-title') @endif</title>
    ...
    <body class="hold-transition {{ config('adminlte.theme') }} layout-top-nav" onload="startTime()">
        <!-- Site wrapper -->
        <div class="wrapper">
