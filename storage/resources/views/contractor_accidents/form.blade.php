<div class="col-md-6">
    ...
    <div class="col-md-12">
        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('contracting_company') ? ' has-error' : '' }}">
            ...
            <textarea name="contractor_statement" id="contractor_statement" style="width: 100%; height: 100px;" tabindex="8">{{ old('contracting_company', $record->contracting_company) }}</textarea>
            @if ($errors->has('contracting_company'))
                <span class="help-block">
                    <strong>{{ $errors->first('contracting_company') }}</strong>
                </span>
...
<div class="col-md-6">
    ...
    <div class="col-md-12">
        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('report_required') ? ' has-error' : '' }}">
            ...
            <select class="form-control" name="wi_required" id="wi_required" tabindex="17">
