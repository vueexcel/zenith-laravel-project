    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" id="btnModalConfirmModelDelete" data-form-id="">Yes
                </button>
        ...
        $('ul.custom-data-changer li a').on('click', function (e) {
            ...
            if (dataChanger.length) {
                ...
                if (inputSelector == '#search-show-input') {
                    ...
                    <?php if(count($sortByParams)): ?> <?php $strTmp = ''; ?>
                        <?php $__currentLoopData = $sortByParams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sortByParam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $strTmp .= (empty($strTmp)) ? "showValue == '$sortByParam'" : " || showValue == '$sortByParam'"; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        showValue = (<?php echo $strTmp; ?>) ? showValue : '';
                    <?php endif; ?>
                }
