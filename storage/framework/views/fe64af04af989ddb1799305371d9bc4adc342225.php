...
<html lang="<?php echo e(app()->getLocale(), false); ?>">
    ...
    <body class="hold-transition <?php echo e(config('adminlte.theme'), false); ?> sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <?php if(auth()->user()): ?>
                <?php echo $__env->make('layouts.partials.backend.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php echo $__env->make('layouts.partials.backend.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            <?php else: ?>
                <style>
