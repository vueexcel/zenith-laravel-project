<?php $__env->startSection('page-title', 'Import XML'); ?>


<?php $__env->startSection('page-subtitle', 'import health concerns from xml'); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on('click', '#import_setting_save', function () {
            ...
            $.ajax({
                url: "<?php echo e(route('import_xml.save'), false); ?>",
                method: "POST",
                data: form.serialize(),
                statusCode: {
                    401: function () {
        ...
        $(document).on('click', '#import_xml', function () {
            ...
            $.ajax({
                url: "<?php echo e(route('import_xml.import'), false); ?>",
                method: "GET",
                data: {},
                statusCode: {
                    401: function () {
