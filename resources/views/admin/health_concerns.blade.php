...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-xs-12">
            <h3 style="color: #00a7d0;">Ramp up Weeks &nbsp;&nbsp;<a class="btn btn-success btn-sm item-create" data-item="ramp_up">Add New</a></h3>
            <div class="col-md-12" id="div_ramp_up" style="background-color: #fff; padding: 10px; min-height: 560px; height: auto"></div>
        </div>
        <!-- ./col -->
    </div>
    <!--------modal-------->
