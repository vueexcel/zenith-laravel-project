            ...
            <div class="box box-info" id="">
                ...
                <form class="form form-horizontal" method="POST" >
                    ...
                    <div class="box-body" >
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="lost_time_incident">All Accident Target: </label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control required-field setting-value" id="all_accident_target" name="all_accident_target" value="{{isset($all_accident_target)?$all_accident_target:''}}">
                            </div>
                            <div class="col-md-2">
                                <button class="btn btn-info save-setting" type="button" data-setting="all_accident_target" style="width: 180px;">Save</button>
                            </div>
                        </div>
