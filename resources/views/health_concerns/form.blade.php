                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('gmir') ? ' has-error' : '' }}">
                            ...
                            <select class="form-control gmir" name="gmir" id="gmir" tabindex="9">
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('origin') ? ' has-error' : (old('origin', $record->origin)) ?? '' ?? ' has-error' }}">
                            ...
                            <select class="form-control" name="origin" id="origin" tabindex="12">
                                ...
                                <option value="Work Aggravated" {{(old('origin', $record->origin)=='Work Aggravated') ? 'selected':''}}>Work Aggravated</option>
                            </select>
                    ...
                    <div class="col-md-12">
                        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('group_code_id') ? ' has-error' : (old('group_code_id', $record->group_code_id)) ?? '' ?? ' has-error' }}">
                            ...
                            <select name="group_code_id" id="group_code_id" class="form-control" style="width: 100%" tabindex="20">
                                <?php
                    ...
                    <div class="col-md-12">
                        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('current_level') ? ' has-error' : (old('current_level', $record->current_level)) ?? '' ?? ' has-error' }}">
                            ...
                            <select name="current_level" id="current_level" class="form-control" style="width: 100%" tabindex="22">
                                <option></option>
                                <option value="Level 1" {{(!empty($record->current_level) && strtolower($record->current_level) == "level 1")? 'selected':''}}>Level 1</option>
                                <option value="Level 2" {{(!empty($record->current_level) && strtolower($record->current_level) == "level 2" )? 'selected':''}}>Level 2</option>
                                <option value="Level 3" {{(!empty($record->current_level) && strtolower($record->current_level) == "level 3" )? 'selected':''}}>Level 3</option>
                                <option value="Level 4 Not Placed" {{(!empty($record->current_level) && strtolower($record->current_level) == "level 4 not placed" )? 'selected':''}}>Level 4 Not Placed</option>
                                <option value="Level 1 - Discharged" {{(!empty($record->current_level) && strtolower($record->current_level) == "level 1 - discharged" )? 'selected':''}}>Level 1 - Discharged</option>
                                <option value="Level 2 - Discharged" {{(!empty($record->current_level) && strtolower($record->current_level) == "level 2 - discharged" )? 'selected':''}}>Level 2 - Discharged</option>
                                <option value="Level 3 - Discharged" {{(!empty($record->current_level) && strtolower($record->current_level) == "level 3 - discharged" )? 'selected':''}}>Level 3 - Discharged</option>
                                <option value="Level 4 (Red Flex) Discharged" {{(!empty($record->current_level) && strtolower($record->current_level) == "level 4 (red flex) discharged" )? 'selected':''}}>Level 4 (Red Flex) Discharged</option>
                                <option value="Level 4 (Red Flex)" {{(!empty($record->current_level) && strtolower($record->current_level) == "level 4 (red flex)" )? 'selected':''}}>Level 4 (Red Flex)</option>
                                <option value="Level 4 Placed" {{(!empty($record->current_level) && strtolower($record->current_level) == "level 4 placed" )? 'selected':''}}>Level 4 Placed</option>
                            </select>
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="col-md-12">
                        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('outcome') ? ' has-error' : '' }}">
                            ...
                            <select name="outcome" id="outcome" class="form-control" style="width: 100%" tabindex="24">
                                <option></option>
                                <option value="Level 1" {{(!empty($record->outcome) && strtolower($record->outcome) == "level 1")? 'selected':''}}>Level 1</option>
                                <option value="Level 2" {{(!empty($record->outcome) && strtolower($record->outcome) == "level 2" )? 'selected':''}}>Level 2</option>
                                <option value="Level 3" {{(!empty($record->outcome) && strtolower($record->outcome) == "level 3" )? 'selected':''}}>Level 3</option>
                                <option value="Level 4 Not Placed" {{(!empty($record->outcome) && strtolower($record->outcome) == "level 4 not placed" )? 'selected':''}}>Level 4 Not Placed</option>
                                <option value="Level 1 - Discharged" {{(!empty($record->outcome) && strtolower($record->outcome) == "level 1 - discharged" )? 'selected':''}}>Level 1 - Discharged</option>
                                <option value="Level 2 - Discharged" {{(!empty($record->outcome) && strtolower($record->outcome) == "level 2 - discharged" )? 'selected':''}}>Level 2 - Discharged</option>
                                <option value="Level 3 - Discharged" {{(!empty($record->outcome) && strtolower($record->outcome) == "level 3 - discharged" )? 'selected':''}}>Level 3 - Discharged</option>
                                <option value="Level 4 (Red Flex) Discharged" {{(!empty($record->outcome) && strtolower($record->outcome) == "level 4 (red flex) discharged" )? 'selected':''}}>Level 4 (Red Flex) Discharged</option>
                                <option value="Level 4 (Red Flex)" {{(!empty($record->outcome) && strtolower($record->outcome) == "level 4 (red flex)" )? 'selected':''}}>Level 4 (Red Flex)</option>
                                <option value="Level 4 Placed" {{(!empty($record->outcome) && strtolower($record->outcome) == "level 4 placed" )? 'selected':''}}>Level 4 Placed</option>
                            </select>
                    ...
                    if((isset($record->next_steps_9) && $record->next_steps_9 != "") || (isset($record->next_steps_9_date) && $record->next_steps_9_date != "")) {
                        ...
                        $next_steps ++;
                        $last_next_date = $record->next_steps_9_date;
                    } else {
                    ...
                    <div class="col-md-12" id="next_step_9" style="{{$next_step9}}">
                        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('next_steps_9') ? ' has-error' : '' }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control datetimepicker-single" name="next_steps_9_date" value="{{(isset($record->next_steps_9_date) && !empty($record->next_steps_9_date))? date('d/m/Y', strtotime($record->next_steps_9_date)):''}}">
                                </div>
                            </div>
                        </div>
                        <!-- /.form-group -->
                    ...
                    if((isset($record->next_steps_8) && $record->next_steps_8 != "") || (isset($record->next_steps_8_date) && $record->next_steps_8_date != "")) {
                        ...
                        $next_steps ++;
                        if(empty($last_next_date))
                            $last_next_date = $record->next_steps_8_date;
                    } else {
                    ...
                    <div class="col-md-12" id="next_step_8" style="{{$next_step8}}">
                        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('next_steps_8') ? ' has-error' : '' }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control datetimepicker-single" name="next_steps_8_date" value="{{(isset($record->next_steps_8_date) && !empty($record->next_steps_8_date))? date('d/m/Y', strtotime($record->next_steps_8_date)):''}}">
                                </div>
                            </div>
                        </div>
                        <!-- /.form-group -->
                    ...
                    if((isset($record->next_steps_7) && $record->next_steps_7 != "") || (isset($record->next_steps_7_date) && $record->next_steps_7_date != "")) {
                        ...
                        $next_steps ++;
                        if(empty($last_next_date))
                            $last_next_date = $record->next_steps_7_date;
                    } else {
                    ...
                    <div class="col-md-12" id="next_step_7" style="{{$next_step7}}">
                        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('next_steps_7') ? ' has-error' : '' }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control datetimepicker-single" name="next_steps_7_date" value="{{(isset($record->next_steps_7_date) && !empty($record->next_steps_7_date))? date('d/m/Y', strtotime($record->next_steps_7_date)):''}}">
                                </div>
                            </div>
                        </div>
                        <!-- /.form-group -->
                    ...
                    if((isset($record->next_steps_6) && $record->next_steps_6 != "") || (isset($record->next_steps_6_date) && $record->next_steps_6_date != "")) {
                        ...
                        $next_steps ++;
                        if(empty($last_next_date))
                            $last_next_date = $record->next_steps_6_date;
                    } else {
                    ...
                    <div class="col-md-12" id="next_step_6" style="{{$next_step6}}">
                        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('next_steps_6') ? ' has-error' : '' }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control datetimepicker-single" name="next_steps_6_date" value="{{(isset($record->next_steps_6_date) && !empty($record->next_steps_6_date))? date('d/m/Y', strtotime($record->next_steps_6_date)):''}}">
                                </div>
                            </div>
                        </div>
                        <!-- /.form-group -->
                    ...
                    if((isset($record->next_steps_5) && $record->next_steps_5 != "") || (isset($record->next_steps_5_date) && $record->next_steps_5_date != "")) {
                        ...
                        $next_steps ++;
                        if(empty($last_next_date))
                            $last_next_date = $record->next_steps_5_date;
                    } else {
                    ...
                    <div class="col-md-12" id="next_step_5" style="{{$next_step5}}">
                        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('next_steps_5') ? ' has-error' : '' }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control datetimepicker-single" name="next_steps_5_date" value="{{(isset($record->next_steps_5_date) && !empty($record->next_steps_5_date))? date('d/m/Y', strtotime($record->next_steps_5_date)):''}}">
                                </div>
                            </div>
                        </div>
                        <!-- /.form-group -->
                    ...
                    if((isset($record->next_steps_4) && $record->next_steps_4 != "") || (isset($record->next_steps_4_date) && $record->next_steps_4_date != "")) {
                        ...
                        $next_steps ++;
                        if(empty($last_next_date))
                            $last_next_date = $record->next_steps_4_date;
                    } else {
                    ...
                    <div class="col-md-12" id="next_step_4" style="{{$next_step4}}">
                        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('next_steps_4') ? ' has-error' : '' }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control datetimepicker-single" name="next_steps_4_date" value="{{(isset($record->next_steps_4_date) && !empty($record->next_steps_4_date))? date('d/m/Y', strtotime($record->next_steps_4_date)):''}}">
                                </div>
                            </div>
                        </div>
                        <!-- /.form-group -->
                    ...
                    if((isset($record->next_steps_3) && $record->next_steps_3 != "") || (isset($record->next_steps_3_date) && $record->next_steps_3_date != "")) {
                        ...
                        $next_steps ++;
                        if(empty($last_next_date))
                            $last_next_date = $record->next_steps_3_date;
                    } else {
                    ...
                    <div class="col-md-12" id="next_step_3" style="{{$next_step3}}">
                        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('next_steps_3') ? ' has-error' : '' }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control datetimepicker-single" name="next_steps_3_date" value="{{(isset($record->next_steps_3_date) && !empty($record->next_steps_3_date))? date('d/m/Y', strtotime($record->next_steps_3_date)):''}}">
                                </div>
                            </div>
                        </div>
                        <!-- /.form-group -->
                    ...
                    if((isset($record->next_steps_2) && $record->next_steps_2 != "") || (isset($record->next_steps_2_date) && $record->next_steps_2_date != "")) {
                        ...
                        $next_steps ++;
                        if(empty($last_next_date))
                            $last_next_date = $record->next_steps_2_date;
                    } else {
                        $next_step2 = "display:none";
                    }

                    if((isset($record->next_steps_2) && $record->next_steps_1 != "") || (isset($record->next_steps_1_date) && $record->next_steps_1_date != "")) {
                        $first_next_date = $record->next_steps_1_date;
                        if(empty($last_next_date))
                            $last_next_date = $record->next_steps_1_date;
                    }

                    if(!empty($first_next_date) && !empty($last_next_date) && $first_next_date != $last_next_date){
                        $earlier = new DateTime($first_next_date);
                        $later = new DateTime($last_next_date);
                        $total_next_days = $later->diff($earlier)->format("%a");
                    } else {
                        $total_next_days = 0;
                    }
                    ?>
                    <div class="col-md-12" id="next_step_2" style="{{$next_step2}}">
                        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('next_steps_2') ? ' has-error' : '' }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control datetimepicker-single" name="next_steps_2_date" value="{{(isset($record->next_steps_2_date) && !empty($record->next_steps_2_date))? date('d/m/Y', strtotime($record->next_steps_2_date)):''}}">
                                </div>
                            </div>
                        </div>
                        <!-- /.form-group -->
                    ...
                    <div class="col-md-12" id="next_step_1">
                        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('next_steps_1') ? ' has-error' : '' }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control datetimepicker-single" name="next_steps_1_date" value="{{(isset($record->next_steps_1) && !empty($record->next_steps_1_date))? date('d/m/Y', strtotime($record->next_steps_1_date)):''}}">
                                </div>
                            </div>
                        </div>
                        <!-- /.form-group -->
                    ...
                    <input type="hidden" id="next_step_id" name="next_step_id" value="">
                    <div class="col-md-offset-6 col-md-6">
                        <label style="padding-top: 7px;">Total number of day from steps: {{ $total_next_days }}</label>
                ...
                <div class="col-md-5">
                    <div class="col-md-12">
                        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('ramp_up') ? ' has-error' : '' }}">
                            <label for="ramp_up">Estimated Current Advice Duration</label>
                    ...
                    <div class="col-md-12">
                        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('fully_fit') ? ' has-error' : '' }}">
                            <label for="fully_fit">Estimated end of Current Advice</label>
                    ...
                    <div class="col-md-12">
                        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('gmir') ? ' has-error' : '' }}">
                            <label for="gmir2">GMIR</label>
                            <select class="form-control gmir" name="gmir2" id="gmir2" tabindex="9">
                                <option value="No" {{(old('gmir', $record->gmir)=='Work') ? 'selected':''}}>No</option>
                                <option value="GMIR_Full" {{(old('gmir', $record->gmir)=='GMIR_Full') ? 'selected':''}}>GMIR - Full</option>
                                <option value="GMIR_Part" {{(old('gmir', $record->gmir)=='GMIR_Part') ? 'selected':''}}>GMIR - Part</option>
                            </select>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(".btnOpenerModalConfirmModelSave").on('click', function () {
            var next_steps = $("#next_steps").val();
            var current_next_step = $("#next_steps_"+next_steps).val();
            $("#next_step_id").val(current_next_step);
        });
    ...
    function get_fully_fit_date()
    {
        ...
        var ohc_appointment = $("#ohc_appointment").val();
        if(ohc_appointment == '' || ohc_appointment == null) {
            return false;
        }
        ...
        $.ajax({
            ...
            method: "GET",
            data: {ramp_up:ramp_up, placement_date:ohc_appointment},
            statusCode: {
                401: function () {
                    console.log('Login expired. Please sign in again.')
                }
