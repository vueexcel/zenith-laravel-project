<div class="col-md-6">
    ...
    <div class="col-md-12">
        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('reported_date') ? ' has-error' : (old('reported_date', $record->reported_date)) ?? '' ?? ' has-error' }}">
            ...
            <input type="text" class="form-control datetimepicker-single" name="reported_date" id="reported_date" placeholder="Reported Date" value="{{ (old('reported_date', $record->reported_date))?date('d/m/Y', strtotime(old('reported_date', $record->reported_date))):'' }}" required tabindex="2">
    ...
    <div class="col-md-12">
        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('accident_date') ? ' has-error' : (old('accident_date', $record->accident_date)) ?? '' ?? ' has-error' }}">
    ...
    <div class="col-md-12">
        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('member_statement') ? ' has-error' : (!empty(old('member_statement', $record->member_statement))) ?? '' ?? ' has-error' }}">
    ...
    <div class="col-md-12">
        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('injury_type_id') ? ' has-error' : (old('injury_type_id', $record->injury_type_id)) ?? '' ?? ' has-error' }}">
...
<div class="col-md-6">
    ...
    <div class="col-md-12">
        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('ohc_comment') ? ' has-error' : (old('ohc_comment', $record->ohc_comment)) ?? '' ?? ' has-error' }}">
    ...
    <div class="col-md-12">
        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('outcome_id') ? ' has-error' : (old('outcome_id', $record->outcome_id)) ?? '' ?? ' has-error' }}">
    ...
    <div class="col-md-12">
        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('escalation') ? ' has-error' : (old('escalation', $record->escalation)) ?? '' ?? ' has-error' }}">
    ...
    <div class="col-md-12">
        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('gir_definition_id') ? ' has-error' : (old('gir_definition_id', $record->gir_definition_id)) ?? '' ?? ' has-error' }}">
    ...
    <div class="col-md-12">
        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('wi_required') ? ' has-error' : (old('wi_required', $record->wi_required)) ?? '' ?? ' has-error' }}">
    ...
    <div class="col-md-12">
        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('riddor') ? ' has-error' : (old('riddor', $record->riddor)) ?? '' ?? ' has-error' }}">
    ...
    <div class="col-md-12">
        <div class="form-group margin-b-5 margin-t-5{{ $errors->has('stop_6') ? ' has-error' : (old('stop_6', $record->stop_6)) ?? '' ?? ' has-error' }}">
