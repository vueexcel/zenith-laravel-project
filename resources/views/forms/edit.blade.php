                                            ...
                                            <div class="col-sm-4" data-field-type="{{ $field->input_type }}">
                                                @if($field->comment == 'Member No' && !empty($member))
                                                    <input type="text" class="form-control form-data" id="{{ $field->db_field }}" name="{{ $field->db_field }}"
                                                           ...
                                                           value="{{ isset($form_data[$field->db_field])?$form_data[$field->db_field]:'' }}">
                                                ...
                                                @else
                                                    ...
                                                    @elseif($field->input_type == 'Textarea')
                                                        <textarea class="form-control form-data" style="height: 100px;" id="{{ $field->db_field }}" name="{{ $field->db_field }}" {{ ($field->is_required == 1)?'required':'' }}>{{ isset($form_data[$field->db_field])?$form_data[$field->db_field]:'' }}</textarea>
                                                    @else
                                                        <select class="form-control form-data" id="{{ $field->db_field }}" name="{{ $field->db_field }}" {{ ($field->is_required == 1)?'required':'' }}>>
                                                            ...
                                                            @foreach($field->answers as $answer)
                                                                <option value="{{$answer->name}}"
                                                                    {{ (isset($form_data[$field->db_field]) && $form_data[$field->db_field] == $answer->name)?'selected':'' }}>
                                                                    {{$answer->name}}
                                                                </option>
                                                            @endforeach
                                                        </select>
