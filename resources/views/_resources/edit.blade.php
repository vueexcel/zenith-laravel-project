...
if($resourceRoutesAlias == "admin::users")
    $addVarsForView['formFiles'] = true;
                ...
                <form class="form" role="form" method="POST" action="{{ $_updateLink }}" {!! $_formFiles === true ? 'enctype="multipart/form-data"' : '' !!}>
                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools">
                            ...
                            @endif
                            <button class="btn btn-sm btn-info margin-r-5 margin-l-5 btnOpenerModalConfirmModelSave" type="button">
                    ...
                    <div class="box-footer clearfix">
                        ...
                        <div class="col-xs-6">
                            <div class="text-center margin-b-5 margin-t-5">
                                <button class="btn btn-info btnOpenerModalConfirmModelSave" type="button">
                                    <i class="fa fa-save"></i> <span>Save</span>
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-6">
                            <div class="text-center margin-b-5 margin-t-5">
                                <a data-form-link="{{ $_listLink }}" class="btn btn-default btn-cancel btnOpenerModalConfirmModelCancel">
...
@section('footer-extras')
    @include('_resources._form-footer-extras', ['sortByParams' => []])
@endsection
